...
### Core Files
- **app.py** - Main application with 4 functions (including settings editor)
...
- **FUNCTION_0_APP_SETTINGS.md** - Help for app settings editor (Function 0)
- **FUNCTION_1_LOAD_DATA.md** - Help for example function 1
